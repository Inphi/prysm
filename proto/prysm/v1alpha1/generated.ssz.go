...
// Hash: 91b2f70f903d58bf912a61f3ef808775c65b305a11683b407852b2c4c19de581
package eth
...
// MarshalSSZ ssz marshals the SignedBlindedBeaconBlockAndBlobsSidecar object
func (s *SignedBlindedBeaconBlockAndBlobsSidecar) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(s)
}

// MarshalSSZTo ssz marshals the SignedBlindedBeaconBlockAndBlobsSidecar object to a target array
func (s *SignedBlindedBeaconBlockAndBlobsSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(8)
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Block == nil {
		s.Block = new(SignedBlindedBeaconBlockWithBlobKZGs)
	}
	offset += s.Block.SizeSSZ()
	...
	dst = ssz.WriteOffset(dst, offset)
	if s.Sidecar == nil {
		s.Sidecar = new(BlobsSidecar)
	}
	offset += s.Sidecar.SizeSSZ()
	...
	// Field (1) 'Sidecar'
	if dst, err = s.Sidecar.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the SignedBlindedBeaconBlockAndBlobsSidecar object
func (s *SignedBlindedBeaconBlockAndBlobsSidecar) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 8 {
		return ssz.ErrSize
	...
	// Field (1) 'Sidecar'
	{
		...
		if err = s.Sidecar.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
// SizeSSZ returns the ssz encoded size in bytes for the SignedBlindedBeaconBlockAndBlobsSidecar object
func (s *SignedBlindedBeaconBlockAndBlobsSidecar) SizeSSZ() (size int) {
	size = 8
	...
	size += s.Sidecar.SizeSSZ()

	return
}

// HashTreeRoot ssz hashes the SignedBlindedBeaconBlockAndBlobsSidecar object
func (s *SignedBlindedBeaconBlockAndBlobsSidecar) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(s)
}

// HashTreeRootWith ssz hashes the SignedBlindedBeaconBlockAndBlobsSidecar object with a hasher
func (s *SignedBlindedBeaconBlockAndBlobsSidecar) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (1) 'Sidecar'
	if err = s.Sidecar.HashTreeRootWith(hh); err != nil {
		return
	}
...
// MarshalSSZ ssz marshals the BlindedBeaconBlockAndBlobsSidecar object
func (b *BlindedBeaconBlockAndBlobsSidecar) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BlindedBeaconBlockAndBlobsSidecar object to a target array
func (b *BlindedBeaconBlockAndBlobsSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(8)
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Block == nil {
		b.Block = new(BlindedBeaconBlockWithBlobKZGs)
	}
	...
	dst = ssz.WriteOffset(dst, offset)
	if b.Sidecar == nil {
		b.Sidecar = new(BlobsSidecar)
	}
	offset += b.Sidecar.SizeSSZ()
	...
	// Field (1) 'Sidecar'
	if dst, err = b.Sidecar.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BlindedBeaconBlockAndBlobsSidecar object
func (b *BlindedBeaconBlockAndBlobsSidecar) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 8 {
		return ssz.ErrSize
	...
	// Field (1) 'Sidecar'
	{
		...
		if err = b.Sidecar.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
// SizeSSZ returns the ssz encoded size in bytes for the BlindedBeaconBlockAndBlobsSidecar object
func (b *BlindedBeaconBlockAndBlobsSidecar) SizeSSZ() (size int) {
	size = 8
	...
	size += b.Sidecar.SizeSSZ()

	return
}

// HashTreeRoot ssz hashes the BlindedBeaconBlockAndBlobsSidecar object
func (b *BlindedBeaconBlockAndBlobsSidecar) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BlindedBeaconBlockAndBlobsSidecar object with a hasher
func (b *BlindedBeaconBlockAndBlobsSidecar) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (1) 'Sidecar'
	if err = b.Sidecar.HashTreeRootWith(hh); err != nil {
		return
	}
...
func (s *SignedBeaconBlockAndBlobsSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	if s.BeaconBlock == nil {
		s.BeaconBlock = new(SignedBeaconBlockWithBlobKZGs)
	}
...
// MarshalSSZ ssz marshals the BeaconBlockAndBlobsSidecar object
func (b *BeaconBlockAndBlobsSidecar) MarshalSSZ() ([]byte, error) {
	return ssz.MarshalSSZ(b)
}

// MarshalSSZTo ssz marshals the BeaconBlockAndBlobsSidecar object to a target array
func (b *BeaconBlockAndBlobsSidecar) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	dst = buf
	offset := int(8)
	...
	if b.BeaconBlock == nil {
		b.BeaconBlock = new(BeaconBlockWithBlobKZGs)
	}
	offset += b.BeaconBlock.SizeSSZ()

	// Offset (1) 'BlobsSidecar'
	dst = ssz.WriteOffset(dst, offset)
	if b.BlobsSidecar == nil {
		b.BlobsSidecar = new(BlobsSidecar)
	}
	offset += b.BlobsSidecar.SizeSSZ()

	// Field (0) 'BeaconBlock'
	if dst, err = b.BeaconBlock.MarshalSSZTo(dst); err != nil {
		return
	}

	// Field (1) 'BlobsSidecar'
	if dst, err = b.BlobsSidecar.MarshalSSZTo(dst); err != nil {
		return
	}
...
// UnmarshalSSZ ssz unmarshals the BeaconBlockAndBlobsSidecar object
func (b *BeaconBlockAndBlobsSidecar) UnmarshalSSZ(buf []byte) error {
	var err error
	size := uint64(len(buf))
	if size < 8 {
		return ssz.ErrSize
	...
	// Field (0) 'BeaconBlock'
	{
		...
		if err = b.BeaconBlock.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	...
	// Field (1) 'BlobsSidecar'
	{
		...
		if err = b.BlobsSidecar.UnmarshalSSZ(buf); err != nil {
			return err
		}
	}
	return err
...
// SizeSSZ returns the ssz encoded size in bytes for the BeaconBlockAndBlobsSidecar object
func (b *BeaconBlockAndBlobsSidecar) SizeSSZ() (size int) {
	size = 8
	...
	size += b.BeaconBlock.SizeSSZ()

	// Field (1) 'BlobsSidecar'
	if b.BlobsSidecar == nil {
		b.BlobsSidecar = new(BlobsSidecar)
	}
	size += b.BlobsSidecar.SizeSSZ()

	return
}

// HashTreeRoot ssz hashes the BeaconBlockAndBlobsSidecar object
func (b *BeaconBlockAndBlobsSidecar) HashTreeRoot() ([32]byte, error) {
	return ssz.HashWithDefaultHasher(b)
}

// HashTreeRootWith ssz hashes the BeaconBlockAndBlobsSidecar object with a hasher
func (b *BeaconBlockAndBlobsSidecar) HashTreeRootWith(hh *ssz.Hasher) (err error) {
	indx := hh.Index()
	...
	// Field (1) 'BlobsSidecar'
	if err = b.BlobsSidecar.HashTreeRootWith(hh); err != nil {
		return
	}
